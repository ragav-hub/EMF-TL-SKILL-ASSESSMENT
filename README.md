...
<img width="350" height="200" alt="image" src="https://github.com/user-attachments/assets/1678a4c7-797a-46d8-9973-d3c2a6b5a318" />


# OVERVIEW:
```
{\displaystyle A=10^{-\mathrm {Loss} /20}\qquad R_{a}=R_{b}=Z_{S}{\frac {1-A}{1+A}}\qquad R_{c}={\frac {Z_{s}^{2}-R_{b}^{2}}{2R_{b}}}}
```
